...
type AccessibilitySpecialRequestsIconName =
  | 'childSeat'
  | 'wheelchair'
  | 'pet'
  | 'language';
...
const accessibilitySpecialRequestsIcons: Record<
  AccessibilitySpecialRequestsIconName,
  string
> = {
        ...
        <div className="mt-14 grid gap-7 lg:grid-cols-2">
          {props.cards.map((card) => (
            ...
            >
              ...
              <h3 className="mt-7 text-lg font-extrabold text-slate-800">
                {card.title}
              </h3>
